    ...
    return(
      ...
      <div className="card-body p-4 gap-2">
        ...
        <div className="flex gap-1 flex-wrap">
          <span className="badge badge-outline badge-sm">Species: {character.species}</span>
          <span className="badge badge-outline badge-sm">Gender: {character.gender}</span>
          <span className="badge badge-outline badge-sm">Origin: {character.origin.name}</span>
        </div>

        <div className="mt-2">
          <p className="text-xs text-base-content/50 uppercase tracking-widest mb-1">Last seen</p>
          <p className="text-sm font-medium truncate">{character.location.name}</p>
        </div>
      </div>
    </div>
